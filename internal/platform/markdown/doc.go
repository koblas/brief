...
// the first unticked checklist item in a section. Entries lists a
// section's column-0 list items ("- ", "* ", "N. "), with continuation
// folding. HeadingLine returns a heading's own 1-based line number. All of
// these are fence-aware, like Section.
package markdown
