...
// that covers. An absent acceptance heading in the briefed step, or an
// absent heading in the state file, does not refuse: Start reports each as
// a Shortfall in Brief.Shortfalls and still returns a Brief carrying every
// other section.
//
