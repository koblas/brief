...
// rows, roles and roles-skill check the install root config.Locate
// resolves — its directory whenever a ".brief.yaml" was found there,
// parseable or not, else wd — against a Claude Code host with no
