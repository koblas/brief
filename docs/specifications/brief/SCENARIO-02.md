...
- [x] Step 20: mark SCENARIO-02 done in `specification.md`'s `## BDD Acceptance Progress`, and rewrite `docs/specifications/brief/STATE.md` folding in the Handoff below
