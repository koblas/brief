...
- [ ] Step 25: `go build ./...`, `go test ./...` (count + delta), `go test -race ./internal/setup/... ./internal/cli/...`, `golangci-lint run ./...` → mark SCENARIO-04 done in specification.md, rewrite STATE.md
